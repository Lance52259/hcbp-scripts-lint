...
**Rule Description:** Validates that parameter assignments within resource, data source, provider, locals, and terraform
...
- Support all Terraform block types including provider and locals blocks
